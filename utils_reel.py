...
def initPositionTripod(robot, distance=90, z=-60):
    sqrt2 = math.sqrt(2)
    # Lateral arms
    anglesLeg1 = computeIK(90, 0, z)
    # anglesLeg4 = computeIK(90, 0, z)
    anglesLeg4 = computeIK(90, 0, z + 30)
    # Back and front arms
    anglesLeg2 = computeIK(distance / sqrt2, -distance / sqrt2, z)
    anglesLeg6 = computeIK(distance / sqrt2, distance / sqrt2, z)
    anglesLeg5 = computeIK(distance / sqrt2, -distance / sqrt2, z)
    anglesLeg3 = computeIK(distance / sqrt2, distance / sqrt2, z)
...
def initPositionForWalk(robot, params, delay=0.0):
    # Lateral arms
