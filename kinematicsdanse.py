...
def computeIKOriented(x, y, z,leg_id):
    offset_x= 0.2
    offset_y= 0
    offset_z= -0.05
...
def triangle(x, z, h, w, t, leg_id=None):
    ...
    if phase < 1:
         # Étape 1 : milieu haut → gauche bas
        ratio = phase
        y1 = w/2
        y2 = -w/2
        z1 = z
    ...
    if leg_id is None:
        ...
        alpha= computeIKOriented(x, target_y, target_z, leg_id)
...
def triangle2(x, z, h, w, t, leg_id=None):
    ...
    if phase < 1:
        ...
        # Étape 2 : droite bas → milieu haut
        ratio = (phase -1) * 2
        y1 = w/2
        y2 = 0
        z1 = z
        ...
        # Étape 3 : milieu haut → gauche bas
        ratio = (phase -1.5) * 2
        y1 = 0
        y2 = -w/2
        z1 = z + h
